...
Eventually, the program may be able to read from a file containing a past journal entry and allow you to edit the entry.

Fields/questions are built in, but can be easily customized and changed inside the code.
